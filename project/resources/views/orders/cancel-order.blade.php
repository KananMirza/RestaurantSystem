            ...
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">Ləğv olunan</li>
            ...
            <div class="container">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th scope="col">Ləğv Olunma Səbəbi</th>
                        <th scope="col">Sifaris Vəziyyəti</th>
                    ...
                    @foreach($orders as $key=>$order)
                        <tr>
                            ...
                            <td class="badge badge-danger"><i class="far fa-frown" style="margin-right: 10px"></i>Ləğv olundu</td>
