            ...
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">Qəbul Olunan</li>
                    ...
                    @foreach($orders as $key=>$order)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline-success" id="preparing" onclick="setPreparingOrder({{$order->id}})">Hazırlanır</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
...
@section('js')
    ...
    <script>
        ...
        const setPreparingOrder = (id) =>{
            $.ajax({
                type: "POST",
                url: "/orders/view/accepting/setpreparingorder",
                data: {
                ...
                success: function (data) {
                    if(data==1){
                        swal({
                            title: "Uğurlu!",
                            text: "Sifariş statusu hazırlanır olaraq dəyiştirildi",
                            icon: "success",
                            button: "Bağla!",
                        });
                        setTimeout(function (){
