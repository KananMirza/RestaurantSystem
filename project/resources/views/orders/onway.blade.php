            ...
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">Yolda olan</li>
                    ...
                    @foreach($orders as $key=>$order)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline-success" id="preparing" onclick="setCompleted({{$order->id}})">Tamamlanan</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
...
@section('js')
    ...
    <script>
        ...
        const setCompleted = (id) => {
            $.ajax({
                type: "POST",
                url: "/orders/view/onway/completed",
                data: {
                ...
                success: function (data) {
                    if(data==1){
                        swal({
                            title: "Uğurlu!",
                            text: "Sifariş statusu tamamlanan olaraq dəyiştirildi",
                            icon: "success",
                            button: "Bağla!",
                        });
                        setTimeout(function (){
