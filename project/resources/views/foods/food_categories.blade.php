...
@section('title',"Foods | Categories List")
@section('content')
    <!-- Main Container -->
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Kateqoriya Siyahısı</h1>
        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    ...
                    <button class="btn btn-outline-primary float-right" data-toggle="modal" data-target="#add">Əlavə
                        et
                    </button>
                </div>
                    ...
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                        ...
                        @foreach($data as $data)
                            <tr>
                                ...
                                <td>
                                    <button onclick="viewCategory({{ $data->id }})" class="btn btn-outline-info">Redaktə Et</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Kateqoriya Redaktə Et</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('editCategory') }}">
                        ...
                        @csrf
                        <div class="form-group">
                            <label for="edit_name" class="col-form-label">Ad:</label>
                            <input type="text" class="form-control" name="edit_name" id="edit_name">
                        </div>
                        <div class="form-group">
                            <label for="edit_slug" class="col-form-label">Slug:</label>
                            <input type="text" class="form-control" disabled="disabled" id="edit_slug">
                        </div>
                        <div class="form-group">
                            <label for="edit_name" class="col-form-label">Status:</label>
                            <select name="edit_status" id="edit_status" class="form-control"></select>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Bağla</button>
                            <button type="submit" onclick="editCategory()" class="btn btn-primary">Redaktə Et</button>
                        </div>
                    </form>
                </div>
