        ...
        <div id="carousel-home">
            <div class="owl-carousel owl-theme">
               @foreach($sliders as $slider)
                <!--/owl-slide-->
                <div class="owl-slide cover lazy" data-bg="url({{'http://127.0.0.1:8000/'.$slider->image}})">
                            ...
                            <div class="row justify-content-center justify-content-md-start">
                                <div class="col-lg-12 static">
                                    <div class="slide-text text-center white">
                                        ...
                                        <div class="owl-slide-animated owl-slide-cta"><a class="btn_1" href="{{ $slider->url }}" role="button">{{ $slider->btn_title }}</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <ul id="banners_grid" class="clearfix">
            <li>
                <a href="menu-1.html" class="img_container">
                    <img src="{{asset('assets/img/banners_cat_placeholder.jpg')}}" data-src="img/banner_1.jpg" alt="" class="lazy">
            ...
            <li>
                <a href="order-food.html" class="img_container">
                    <img src="{{asset('assets/img/banners_cat_placeholder.jpg')}}" data-src="img/banner_2.jpg" alt="" class="lazy">
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <h3>Delivery</h3>
            ...
            <li>
                <a href="gallery.html" class="img_container">
                    <img src="{{'assets/img/banners_cat_placeholder.jpg'}}" data-src="img/banner_3.jpg" alt="" class="lazy">
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <h3>Inside Foores</h3>
            ...
            <div class="container margin_120_100 home_intro">
                <div class="row justify-content-center d-flex align-items-center">
                    <div class="col-lg-5 text-lg-center d-none d-lg-block" data-cue="slideInUp">
                        <figure>
                            <img src="{{asset('assets/img/home_1_placeholder.png')}}" data-src="{{asset('assets/img/home_1.jpg')}}" width="354" height="440" alt="" class="img-fluid lazy">
                    ...
                    <div class="col-lg-5 pt-lg-4" data-cue="slideInUp" data-delay="500">
                        ...
                        <p><img src="{{asset('assets/img/signature.png')}}" width="140" height="50" alt="" class="mt-3"></p>
                    </div>
                </div>
                <!--/row -->
            </div>
            ...
            <div class="container margin_120_100" data-cue="slideInUp">
                ...
                <div class="banner lazy" data-bg="url(img/banner_bg.jpg)">
                    <div class="wrapper d-flex align-items-center justify-content-between opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        ...
                        <figure class="d-none d-lg-block"><img src="{{asset('assets/img/banner.svg')}}" alt="" width="200" height="200" class="img-fluid"></figure>
                    </div>
                    <!-- /wrapper -->
                </div>
                <!-- /banner -->
                <div class="row magnific-gallery homepage add_bottom_25">
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/3.jpg')}}" title="Summer Berry" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/3.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                    ...
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/4.jpg')}}" title="Coconut Tart" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/4.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                            <div class="menu_title">
                    ...
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/5.jpg')}}" title="Pumpkin Cookies" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/5.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                            <div class="menu_title">
                    ...
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/6.jpg')}}" title="Cookies Cream Cheese" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/7.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                            <div class="menu_title">
                    ...
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/8.jpg')}}" title="Chocolate Cupcakes" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/8.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                            <div class="menu_title">
                    ...
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/9.jpg')}}" title="Chocolate Cupcakes" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/9.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                            <div class="menu_title">
                                <h3>Chocolate Cupcakes</h3><em>$14</em>
                    ...
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/10.jpg')}}" title="Soft shell crab" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/10.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                            <div class="menu_title">
                    ...
                    <div class="col-lg-6" data-cue="slideInUp">
                        <div class="menu_item">
                            <figure>
                                <a href="{{asset('assets/img/menu_items/large/11.jpg')}}" title="Soft shell crab" data-effect="mfp-zoom-in">
                                    <img src="{{asset('assets/img/menu_items/menu_items_placeholder.png')}}" data-src="img/menu_items/11.jpg" class="lazy" alt="">
                                </a>
                            </figure>
                            <div class="menu_title">
                                <h3>Soft shell crab</h3><em>$14</em>
